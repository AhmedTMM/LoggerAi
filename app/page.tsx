...
function StatCard({
  ...
  return (
    <Link href={href} className="group">
      <div className="bg-white rounded-xl border border-zinc-200 p-5 hover:shadow-md transition-all">
        ...
        <div className="mt-3 flex items-center text-sm text-zinc-500 group-hover:text-blue-600">
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-zinc-500 mt-1">Your fleet overview</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-zinc-200 p-4">
        <h2 className="text-lg font-semibold text-zinc-900 mb-4">Flight Map</h2>
